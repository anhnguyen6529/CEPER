...
import { FPhuongPhapDieuTri } from "../forms";

const CLPhuongPhapDieuTri = ({ open, id }) => {
    const [edit, setEdit] = useState(false);
    const content = useSelector((state) => state.HSBA.phuongPhapDieuTri);
    ...
    return (
        <Collapse in={open} timeout="auto" unmountOnExit sx={{ mb: 3 }}>
            ...
            : <FPhuongPhapDieuTri setEdit={setEdit} />
            }
        </Collapse>
    )
}

export default CLPhuongPhapDieuTri;